...
if(ini_get("register_globals") == "on" || ini_get("register_globals")=="1") //check whether register_globals is turned on - if it is, we need to not continue
{
	...
	echo "<fieldset style='margin:15px;'><legend><b style='font-size:18px'>".$lang['db_ch']."</b></legend>";
	...
	echo "</fieldset>";
	echo "<fieldset style='margin:15px;font-size:15px; text-align:center;'><legend style='font-size:15px; text-align:center;'>";
	echo "<a style='font-size:16px;' href='".PAGE."'";
	if(!isset($_GET['table']))
	...
	if($directory!==false && is_writable($directory))
	{
		echo "<fieldset style='margin:15px;'><legend style='font-size:12px; text-align:center;'><b>".$lang['db_create']."</b> ".helpLink($lang['help2'])."</legend>"; 
		echo "<form name='create_database' method='post' action='".PAGE."'>";
		echo "<input type='text' name='new_dbname' style='width:150px;'/> <input type='submit' value='".$lang['create']."' class='btn'/>";
		echo "</form>";
		echo "</fieldset>";
