...
;(function($, window, document, undefined)
{
	...
	var defaults = {
			...
			emptyClass      : 'dd-empty',
			expandBtnHTML   : '<button class="LeftofLI" data-action="expand" type="button"></button>',
			collapseBtnHTML : '<button class="LeftofLI" data-action="collapse" type="button"></button>',
			group           : 0,
			maxDepth        : 5,
			threshold       : 20,
			/* callback */
